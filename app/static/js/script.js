...
function checkBudget(summary) {
    ...
    console.log('Raw Monthly Budget:', budgetElement); // Affiche la valeur brute pour verification dans la console du navigator 
...
document.getElementById('budget-form').addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        // Récupérer et afficher le budget actualisé après mise à jour
        fetch('/get_budget')
            .then(response => response.json())
            .then(data => {
